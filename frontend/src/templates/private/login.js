...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const { data: res } = await axios.post(backend + 'auth', data);
      //Write the token in the localStorage
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className='inputBox'>
          ...
          <label>
            ...
            <span style={{transitionDelay: '250ms'}}>
              A
            </span>
        ...
        <div className='inputBox'>
          ...
          <div id='toggle' onClick={showHidePassword}>
